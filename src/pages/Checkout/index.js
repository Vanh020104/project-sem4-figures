...
import PAYPAL from '../../assets/media/icons/Paypal.png';
function Checkout() {
    ...
    const handlePaymentMethodChange = (e) => {
        setFormData({ ...formData, paymentMethod: e.target.value, totalCost });
    };

    const handleSubmit = () => {
        const { firstName, lastName, address, phone, country, postalCode, email, paymentMethod } = formData;

        if (!firstName || !lastName || !address || !phone || !country || !postalCode || !email || !paymentMethod) {
        ...
        const adjustedTotalCost = paymentMethod === 'VNPAY' ? totalCost * conversionRate : totalCost;

        const orderData = {
            userId,
            ...formData,
            totalPrice: totalCost, // Lưu totalCost gốc (USD) vào database
                                    ...
                                    <div className="col-xl-4">
                                        <div className="order-summary-block">
                                            ...
                                            <div className="block mb-32">
                                                ...
                                                <form className="promo-code mb-32">
