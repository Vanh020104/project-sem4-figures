...
//                             <p style={{ color: 'white' }}>
//                                 Thank you for your trust and ordering from us! Your order will be processed soon!
//                             </p>
//                         </div>
//                     </div>
//                 </div>
...
function Thankyou() {
    ...
    useEffect(() => {
        ...
        const updateOrderStatus = async (url, options) => {
            try {
        ...
        if (!isSuccess) {
            if (vnp_ResponseCode) {
                setBankCode('VNPAY');
                const url = `http://localhost:8080/api/v1/payment/vnPayReturn/${orderId}?vnp_ResponseCode=${vnp_ResponseCode}`;
                const options = {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                ...
                updateOrderStatus(url, options);
            }
        } else {
            setBankCode('PAYPAL');
            const url = `http://localhost:8080/api/v1/payment/executePaypal`;
            const options = {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
